...
const variants = {
  ...
  secondary: "border-line bg-surface text-foreground hover:border-brand hover:text-brand-strong",
  ghost: "border-transparent bg-transparent text-brand-strong hover:bg-white/60",
};
